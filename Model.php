...
abstract class Model
{
        ...
        foreach ($this->rules() as $attribute => $rules) {
            ...
            foreach ($rules as $rule) {
                ...
                if($ruleName === self::RULE_UNIQUE)
                {
                    ...
                    $uniqueTbl  = $className::tableName();
                    $statement  = Application::$app->db->prepare("SELECT * FROM $uniqueTbl WHERE $uniqueAttr=:attr");
                    ...
                    if($record)
                    {
                        $this->addErrors($attribute, self::RULE_UNIQUE, ['field'=> $this->getLabel($attribute)]);
                    }
    ...
    private function addErrors(string $attribute, string $rule, $params=[])
    {
    ...
    public function errorMessages()
    {
        return [
            ...
            self::RULE_EMAIL    => 'Email Should be Valid!',
